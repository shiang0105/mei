...
/**
 * This {@code IntentService} does the app's actual work. {@code SampleAlarmReceiver} (a {@code WakefulBroadcastReceiver}) holds a
 * partial wake lock for this service while the service does its work. When the service is finished, it calls
...
public class SampleSchedulingService extends IntentService {
    ...
    private void sendNotification(String msg) {
        ...
        notification.sound = Uri.parse("android.resource://"
                + MeiMenApplication.getContext().getPackageName() + "/" + R.raw.test_audio);
